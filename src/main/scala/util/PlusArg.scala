...
object Doctypes {
  ...
  /** Converts an Int => "INT" */
  implicit val intToDoctype: Doctypeable[Int] = new Doctypeable[Int] {
    def toDoctype(a: Option[Int]) = "INT"
  }

  /** Converts a BigInt => "INT" */
  implicit val bigIntToDoctype: Doctypeable[BigInt] = new Doctypeable[BigInt] {
    def toDoctype(a: Option[BigInt]) = "INT"
  }

  /** Converts a String => "STRING" */
  implicit val stringToDoctype: Doctypeable[String] = new Doctypeable[String] {
